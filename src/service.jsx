    ...
    <>
      ...
      <div className="text-navyblue py-5 container">
        <motion.h2
          ...
          className=" text-center  col-lg-5  pb-5 pb-md-0 m-auto fw-bolder  display-6"
        >
        ...
        <div className="   m-auto d-flex flex-column flex-md-row gap-md-2 flex-wrap gap-4 justify-content-center p-md-5">
          <motion.div
            initial={{ scale: 1, y: -50, zIndex: -12 }}
            whileInView={{
              y: 0,
              zIndex: 1,
              transition: {
          ...
          >
            <img src={gcs} alt="" />
            <p>
              <b className="fs-5 ">Group Coaching Sessions</b>
            </p>
          ...
          >
            <img src={frame2} alt="" />
            <p>
              <b className="fs-5 ">Online course</b>
            </p>
            <p className=" col-lg-11">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua minim
          ...
          >
            <img src={coaching} alt="" />
            <p>
              <b className="fs-5 ">1:1 Coaching</b>
            </p>
            <p className=" col-lg-11">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua minim
      ...
      <div className="text-navyblue p-4 mb-lg-5">
       ...
       whileInView={{
        ...
        className=" display-6  fw-bolder col-lg-4">
        ...
        <div className="d-flex flex-column flex-lg-row justify-content-between align-items-center">
          <motion.div
            initial={{ scale: 1, x: -500, zIndex: -12 }}
            whileInView={{
              x: 0,
              zIndex: 1,
              transition: {
      ...
      <div>
        ...
        >
          <div class="accordion-item accordion-flush border-0">
            <h2
              class="accordion-header   border-top"
