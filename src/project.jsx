  ...
  return (
    <div className="p-lg-5 p-3 py-5">
      <div className="bg-milk d-flex gap-4 flex-column col-12 rounded-5 p-3 p-lg-5">
        <h2 className="fw-bolder fs-1 text-navyblue m-0 text-center">
          Division App
        </h2>
        ...
        <div className=" d-flex justify-content-center">
          <motion.button
            className=" col-lg-2 col-4 btn bg-lightgreen rounded text-white"
        ...
        <div className="fs-sm-3  fw-bolder text-navyblue d-flex justify-content-center align-items-center">
          ...
          <p className="fw-bolder  text-navyblue m-0">{result} </p>
        </div>
      </div>
    </div>
  );
