...
function Free() {
  ...
  const handleClick =()=> {
    ...
    <section className='col-12 d-flex flex-column flex-md-row text-navyblue'>
        ...
        <h2 className="text-navyblue fs-1 col-lg-8 fw-bolder"> Results that speak for themselves</h2>
<p className='col-lg-8 col-12'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua minim veniam.</p>
    <div className='d-flex flex-column gap-2 col-lg-6 col-10 '>
        <input type="text" name="message" placeholder='Name' value={message} id='message' onChange={handleChange} />
...
<p className='col-lg-8'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua minim veniam.
 ...
 <div className=' border d-flex justify-content-center col-lg-4 col-11 m-auto  position-relative bottom10'>
    <video src={vid} muted autoPlay  controls className='m-auto w-100 position-relative' ></video>
   </div>


<section className=' mb-3 position-relative px-4  text-center text-navyblue d-flex flex-column gap-4 '>
<h2 className='display-6 m-auto  fw-bolder col-lg-6'>Don’t miss out on my <span className='text-lightgreen'>‘Live life at the full potential’</span> free guide </h2>
<p className="m-auto col-lg-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua minim veniam.
...
<button type="button"  class="btn bg-lightgreen rounded text-white col-lg-3 m-auto  ">Book a session with us</button>
   ...
   <div className=' d-none d-lg-block position-absolute top-50 end-0'><img src={smalltwo} alt="" /> </div>            
   <div className=' d-none d-lg-flex position-relative    justify-content-end container '><img src={smallfour} alt="" /> </div>            
